 ...
 * Use the [AdminStatisticsContainerFragment.newInstance] factory method to
...
class AdminStatisticsContainerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminStatisticsContainerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminStatisticsContainerFragment().apply {
