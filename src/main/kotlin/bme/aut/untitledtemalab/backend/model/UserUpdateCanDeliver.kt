...
class UserUpdateCanDeliver : UserUpdate {
    ...
    fun userId(userId: Long?): bme.aut.untitledtemalab.backend.model.UserUpdateCanDeliver {
        this.userId = userId
        return this
    }

    fun password(password: String?): bme.aut.untitledtemalab.backend.model.UserUpdateCanDeliver {
        this.password = password
        return this
    }

    fun canDeliver(canDeliver: Boolean?): bme.aut.untitledtemalab.backend.model.UserUpdateCanDeliver {
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val userUpdateCanDeliver: bme.aut.untitledtemalab.backend.model.UserUpdateCanDeliver = o as bme.aut.untitledtemalab.backend.model.UserUpdateCanDeliver
